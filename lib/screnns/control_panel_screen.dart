...
class _ControlPanelScreenState extends State<ControlPanelScreen> {
  ...
  Future<void> _checkLoginStatus() async {
    ...
    // إذا لم يكن مسجل دخول أو ليس من نوع control، العودة لصفحة تسجيل الدخول
  ...
  // ===== دوال إدارة البيانات المركزية =====

  // ===== دوال عرض وإدارة البيانات المركزية =====
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              label: const Text('إدارة التخصصات'),
                          ...
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              label: const Text('إدارة التأمين'),
                              style: ElevatedButton.styleFrom(
