    ...
    try {
      ...
      yPosition += 35;
       ...
       if (periodStartTime != null && periodStartTime.isNotEmpty) {
         ...
         print('لم يتم العثور على وقت بداية الفترة، استخدام النص الافتراضي');
         // محاولة إنشاء وقت افتراضي بناءً على الفترة
         if (period == 'morning') {
           attendanceText = '• يرجى الحضور الساعة 8:00 صباحاً';
           print('تم استخدام وقت افتراضي للصباح: 8:00 صباحاً');
         } else if (period == 'evening') {
           attendanceText = '• يرجى الحضور الساعة 18:00 مساءً';
           print('تم استخدام وقت افتراضي للمساء: 18:00 مساءً');
         }
       }
