...
class SyncfusionPdfService {
  ...
  static Future<void> _addWatermark(
    ...
    try {
      ...
      double y =
          pageHeight * 0.1; // رفع العلامة المائية لأعلى (10% من أعلى الصفحة)
  ...
  static Future<void> generateBookingPdf({
    ...
    try {
      ...
      PdfFont boldFont = PdfStandardFont(
        PdfFontFamily.helvetica,
        16,
        style: PdfFontStyle.bold,
      );
      ...
      // النص في أقصى اليمين
      graphics.drawString(
        'أعمال الجودة الذكية .. أنظمة وتطبيقات ذكية لمستقبل أعمالك',
        arabicFont,
        brush: PdfSolidBrush(PdfColor(0, 0, 0)),
